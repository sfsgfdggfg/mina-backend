...
function renderAirRateSourceSettings(payload = {}, reviewsPayload = {}, tablePayload = {}, surchargePayload = {}) {
  ...
  panel.append(node("div","PDF ticari sır olarak korunur. Bu ekran fiyat üretmez. Yapı, satır ve surcharge çıkarımı yerel/deterministik çalışır; AI parser çağrılmaz ve tam extracted text state/audit kaydına yazılmaz.","notice"));
