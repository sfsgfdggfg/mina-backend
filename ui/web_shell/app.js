...
function appendReviewedSurchargeCostPreview(row, tableReview, candidate, surchargeReview, additionalCostEvidence = [], costScopeReviews = [], unsupportedCostReviews = [], fxEvidence = [], customerProfiles = []) {
...
function renderAirRateSourceSettings(payload = {}, validityPayload = {}, roundingPayload = {}, additionalCostPayload = {}, costScopePayload = {}, unsupportedCostPayload = {}, fxPayload = {}, availabilityPayload = {}, reviewsPayload = {}, tablePayload = {}, surchargePayload = {}, customerProfiles = []) {
  const panel=node("section","","settings-panel"); const h=node("div","","settings-heading");
