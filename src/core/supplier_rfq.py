...
class SupplierSelectionExplanation(BaseModel):
    ...
    customer_context_learning_adjustment: float = Field(default=0.0, ge=-0.025, le=0.025)
    ...
    customer_learning_context_key: Optional[str] = Field(default=None, max_length=240)
    ...
    customer_context_learning_fact_ids: list[str] = Field(default_factory=list, max_length=20)
