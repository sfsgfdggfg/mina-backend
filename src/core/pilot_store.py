...
PERSISTENT_STATE_NAMESPACES = (
    ...
    "supplier_negotiation_evidence",
    "supplier_negotiation_by_entry",
    "approved_job_supplier_awards",
    ...
    "air_rate_weight_rounding_reviews",
    "air_fx_rate_evidence",
    ...
    "air_unsupported_cost_semantics_reviews",
    ...
    "air_learning_feedback",
    "air_learning_feedback_by_entry",
