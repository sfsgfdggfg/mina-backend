                    ...
                    messages=[
                        {
                            ...
                            "content": (
                                ...
                                "needs_clarification, and acknowledged. Use "
                                "acknowledged only when the supplier confirms "
                                "they received/saw the request or are working on it "
                                "without providing a commercial result. For a field that is "
