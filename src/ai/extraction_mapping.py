...
def shipment_from_extraction(
    ...
    return ShipmentProposalSnapshot(
        ...
        pickup_contact_name=extracted.pickup_contact_name,
        pickup_contact_phone=extracted.pickup_contact_phone,
        ...
        delivery_contact_name=extracted.delivery_contact_name,
        delivery_contact_phone=extracted.delivery_contact_phone,
