...
class PilotOperatorClient:
    ...
    def get_operational_shift_summary(self) -> Any:
        return self._request("GET", "/operational-work-shift-summary")
    ...
    def get_operational_shift_continuity(self) -> Any:
        return self._request("GET", "/operational-work-shift-continuity")

    def accept_operational_shift_open(self) -> Any:
        return self._request("POST", "/operational-work-shift-open-accept", {})

    def list_operational_shift_open_acceptances(self) -> Any:
        return self._request("GET", "/operational-work-shift-open-acceptances")

    def attest_operational_shift_close(self) -> Any:
        return self._request("POST", "/operational-work-shift-close-attest", {})

    def list_operational_shift_close_receipts(self) -> Any:
        return self._request("GET", "/operational-work-shift-close-receipts")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    work.add_parser("continuity")
    work.add_parser("open-accept")
    work.add_parser("open-acceptances")
    ...
    attachment_review.add_parser("queue")
...
def _execute(client: PilotOperatorClient, args: argparse.Namespace) -> Any:
    ...
    if args.command == "work":
        ...
        if args.action == "continuity":
            return client.get_operational_shift_continuity()
        if args.action == "open-accept":
            return client.accept_operational_shift_open()
        if args.action == "open-acceptances":
            return client.list_operational_shift_open_acceptances()
        if args.action == "close-attest":
            return client.attest_operational_shift_close()
        if args.action == "close-receipts":
            return client.list_operational_shift_close_receipts()
        if args.action == "get":
