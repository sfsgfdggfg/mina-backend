...
def evaluate_pilot_access_regressions() -> dict:
    ...
    expected_routes = (
        ...
        ("GET", "/operational-work-shift-open-reconciliation"),
        ("GET", "/operational-work-shift-continuity"),
        ("POST", "/operational-work-shift-open-accept"),
        ("GET", "/operational-work-shift-open-acceptances"),
        ("POST", "/operational-work-shift-close-attest"),
        ("GET", "/operational-work-shift-close-receipts"),
        ...
        ("POST", "/operational-work-items/customer_extraction_confirmation:proposal-1/renew"),
        ("POST", "/operational-work-items/customer_extraction_confirmation:proposal-1/takeover"),
        ("POST", "/operational-work-items/customer_extraction_confirmation:proposal-1/handoff"),
        ("POST", "/operational-work-items/customer_extraction_confirmation:proposal-1/release"),
        ...
        ("POST", "/supplier-rfqs/r1/acknowledge-seen"),
        ("GET", "/supplier-rfq-workflows/w1/dispatch-status"),
        ("POST", "/supplier-rfq-workflows/w1/authorize-secondary-after-negotiation"),
